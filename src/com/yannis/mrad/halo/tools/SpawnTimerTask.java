...
public class SpawnTimerTask extends TimerTask{
	...
	public Enemy getEnemyInstance(Class chosenEnemyType) throws GameException
	{
		...
		if(chosenEnemyType.equals(InfectionForm.class))
		{
			...
			enemy.setSpeedFactor(renderer.getmContext().getResources().getInteger(R.integer.infection_speed));
		...
		if(chosenEnemyType.equals(CombatForm.class))
		{
			...
			enemy.setSpeedFactor(renderer.getmContext().getResources().getInteger(R.integer.combat1_speed));
		...
		if(chosenEnemyType.equals(FastCombatForm.class))
		{
			...
			enemy.setSpeedFactor(renderer.getmContext().getResources().getInteger(R.integer.combat2_speed));
		...
		if(chosenEnemyType.equals(CarrierForm.class))
		{
			...
			enemy.setSpeedFactor(renderer.getmContext().getResources().getInteger(R.integer.carrier_speed));
